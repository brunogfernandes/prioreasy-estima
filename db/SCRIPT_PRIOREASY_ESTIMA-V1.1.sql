...
CREATE TABLE PROJETOS (
    ...
    PRO_RESTFACTOR DOUBLE(4,2),
    PRO_RESEFACTOR DOUBLE(4,2)
);
...
CREATE TABLE COLABORADORES (
    ...
    COL_CARGO ENUM('Gerente de Projeto','Analista de Sistemas','Desenvolvedor','Product Owner','Scrum Master'),
...
CREATE TABLE ESTIMATIVAS_ESFORCOS (
    ...
    EST_DATA_ESTIMATIVA VARCHAR(20),
    FK_PROJETOS_PRO_ID INTEGER
);
...
ALTER TABLE FATORES_TECNICOS_PROJETOS ADD CONSTRAINT FK_FATORES_TECNICOS_PROJETOS_3
...
ALTER TABLE FATORES_AMBIENTAIS_PROJETOS ADD CONSTRAINT FK_FATORES_AMBIENTAIS_PROJETOS_3
